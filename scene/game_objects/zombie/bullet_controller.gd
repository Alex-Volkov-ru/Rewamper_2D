...
@export var damage: int = 10  # Базовый урон одной пули
@export var critical_chance: float = 0.1  # Шанс критического удара
...
func spawn_bullet(start_position: Vector2, target_position: Vector2):
	...
	var bullet_instance = bullet_ability_scene.instantiate() as Bullet # Убедитесь, что это Node2D
